...
class Customer:
    ...
    def return_movie(self, movie):
        if movie in self.rented_movies:
            ...
            print (f"{movie.title} didnot rent {movie.title}")
...
def main():
    ...
    # Initalize the Customers
    customers={
        "Alice": Customer("Alice"),
        "Bibek": Customer("Bibek")
    }
    while True:
        menu()
        ...
        if choice=="1":
            ...
            if customer and movie:
                ...
                print(f"Movie '{title}' add to the store.")
            elif choice=="6":
                print("Exiting..")
                break
            else:
